...
<tr>
<td class="left-label">Premium / Discount %:</td>
<td class="middle-data"><?php if($g_view['deal_data']['discount_to_last']=="0.0") echo "n/a"; else echo $g_view['deal_data']['discount_to_last']."%";?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="discount_to_last" class="shorttxtinput" /> %</td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Enter additional details here (e.g. selling shareholders):</td>
<td colspan="3">
