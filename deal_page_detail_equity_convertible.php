...
<tr>
<td class="left-label">Years to maturity:</td>
...
<tr>
<td class="left-label">Current Rating:</td>
<td class="middle-data"><?php if($g_view['deal_data']['current_rating']=="") echo "n/a"; else echo $g_view['deal_data']['current_rating'];?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="current_rating" class="txtinput" /></td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Format:</td>
<td class="middle-data"><?php if($g_view['deal_data']['format']=="") echo "n/a"; else echo $g_view['deal_data']['format'];?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="format" class="txtinput" /></td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Guarantor:</td>
<td class="middle-data"><?php if($g_view['deal_data']['guarantor']=="") echo "n/a"; else echo $g_view['deal_data']['guarantor'];?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="guarantor" class="txtinput" /></td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Years to call:</td>
<td class="middle-data"><?php if($g_view['deal_data']['year_to_call']=="") echo "n/a"; else echo $g_view['deal_data']['year_to_call'];?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="year_to_call" class="shorttxtinput" /></td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Call Date:</td>
<td class="middle-data">
<?php if($g_view['deal_data']['call_date']=="0000-00-00"||$g_view['deal_data']['call_date']=="") echo "n/a"; else echo ymd_to_dmy($g_view['deal_data']['call_date']);?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="call_date" id="call_date" class="shorttxtinput" />
<script type="text/javascript">
          // <![CDATA[       
            var opts = {                            
...
?>
<tr>
<td class="left-label">Redemption Price:</td>
<td class="middle-data"><?php if($g_view['deal_data']['redemption_price']=="") echo "n/a"; else echo $g_view['deal_data']['redemption_price'];?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="redemption_price" class="shorttxtinput" /></td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
?>
<tr>
<td class="left-label">Reference Price:</td>
<td class="middle-data"><?php if($g_view['deal_data']['reference_price']=="0.0") echo "n/a"; else echo convert_million_for_display($g_view['deal_data']['reference_price'])." ".$reference_price_currency;?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="reference_price" class="shorttxtinput" /></td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Conversion Price:</td>
<td class="middle-data"><?php if($g_view['deal_data']['conversion_price']=="0.0") echo "n/a"; else echo convert_million_for_display($g_view['deal_data']['conversion_price'])." ".$reference_price_currency;?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="conversion_price" class="shorttxtinput" /></td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Currency of Reference price:<br />(if different from local currency for the deal)</td>
<td class="middle-data"><?php if($g_view['deal_data']['currency_reference_price'] == "") echo "n/a"; else echo $g_view['deal_data']['currency_reference_price'];?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="currency_reference_price" id="currency_reference_price" class="txtinput" /></td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Conversion Premium:</td>
<td class="middle-data"><?php if($g_view['deal_data']['conversion_premia_percent']=="0.0") echo "n/a"; else echo $g_view['deal_data']['conversion_premia_percent']."%";?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="conversion_premia_percent" class="shorttxtinput" /> %</td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Number of shares underlying:</td>
...
<tr>
<td class="left-label">Average Daily Trading Volume:</td>
<td class="middle-data"><?php if($g_view['deal_data']['avg_daily_trading_vol_million']=="0.0") echo "n/a"; else echo convert_million_for_display($g_view['deal_data']['avg_daily_trading_vol_million'])."m";?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="avg_daily_trading_vol_million" class="shorttxtinput" /> (in million)</td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Underlying shares versus ADTV:</td>
<td class="middle-data"><?php if($g_view['deal_data']['shares_underlying_vs_adtv_ratio']=="0.0") echo "n/a"; else echo convert_million_for_display($g_view['deal_data']['shares_underlying_vs_adtv_ratio']);?></td>
<td class="separation"></td>
<td class="right-input"><input type="text" name="shares_underlying_vs_adtv_ratio" class="shorttxtinput" /></td>
</tr>
<tr>
<td colspan="2" class="vseparation"></td>
<td class="separation"></td>
...
<td class="middle-data"><?php if($g_view['deal_data']['base_fee']==""||$g_view['deal_data']['base_fee']==0.0) echo "n/a"; else echo $g_view['deal_data']['base_fee']."%";?></td>
<td class="separation"></td>
...
<tr>
<td class="left-label">Dividend protection mechanism:</td>
<td class="middle-data"><?php if($g_view['deal_data']['dividend_protection'] == 'y'){?>Yes<?php }else{?>No<?php }?></td>
<td class="separation"></td>
<td class="right-input">
<input type="radio" name="dividend_protection" value="y">Yes&nbsp;&nbsp;
<input type="radio" name="dividend_protection" value="n">No
</td>
</tr>
...
<tr>
<td class="left-label">Enter additional details here (e.g. terms, redemption, ratings, puts/ calls, dividend protection mechanism):</td>
<td colspan="3">
