...
<td>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="input" style="width:390px;">
		<tr>
			<td><input type="text" name="top_search_term" id="top_search_term" value="<?php if(isset($_POST['top_search_term'])) echo $g_mc->view_to_view($_POST['top_search_term']);?>" style="width:360px;" /></td>
