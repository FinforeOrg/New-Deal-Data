<!--search form-->
<form method="post" action="company_search.php">
...
<tr>
<td><input type="text" name="search" id="search" value="<?php echo $g_view['search_form_input'];?>" title="company name or industry" alt="company name or industry" /></td>
</tr>
</table>
</td>
<td>&nbsp;</td>
