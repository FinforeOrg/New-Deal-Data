...
$is_resumed = true;$job_id = "728-1283781190";
...
for($j=$sweeps_done;$j<$total_sweeps;$j++){
	...
	*********/
	if(time()-$time_started > $time_limit){
		...
		**********/
		$success = $g_maketop->store_execution_state($job_id,$country_preset_vector,$sector_industry_preset_vector,$deal_type_preset_vector,$deal_size_preset_vector,$deal_date_preset_vector,$ranking_criteria_vector,$cache,$j+1);
		if(!$success){
