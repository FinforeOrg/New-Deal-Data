...
<tr><td colspan="2" align="center"><strong><?php if($g_view['msg']!=""){echo $g_view['msg'];}else{echo "PLEASE LOGIN TO THE SUPER ADMIN AREA";} ?></strong></td></tr><br />
...
<input type="hidden" name="action" value="retrieve_pass" />
<table width="50%" cellpadding="0" cellspacing="10" border="0">
<tr>
<td width="40%" align="center">Forgot your password?</td>
