<?php
/****************
This is used to search for lawyer. Visitor type lawyer's name
...
if(!$g_account->is_site_member_logged()){
	$g_view['page_heading'] = "Lawyer search result";
...
if(isset($_POST['myaction'])&&($_POST['myaction']=="search")){
	...
	$success = $g_mem->front_search_for_member_of_type_paged($_POST['top_search_term'],"lawyer",$g_view['start_offset'],$g_view['num_to_show']+1,$g_view['data'],$g_view['data_count'],$g_view['total_data_count']);
	
	if(!$success){
		die("Cannot search for lawyer");
	}
	/////////////////////////////////////////
	$g_view['search_form_input'] = $g_mc->view_to_view($_POST['top_search_term']);
	
}else{
	$g_view['search_form_input'] = "enter name of the lawyer";
	$g_view['data_count'] = 0;
}
////////////////////////////////
...
***/
$g_view['content_view'] = "lawyer_search_view.php";
require("content_view.php");
?>