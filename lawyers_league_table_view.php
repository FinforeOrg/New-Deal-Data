...
<tr>
<td style="text-align:left"><h1>League Table for Lawyers</h1></td>
<?php
/***
1/jun/2010
...
****/
?>
<!--<td style="text-align:right;"><a href="top_law_firms_per_criteria.php" class="black_link">See details of the 5 best law firms</a></td>-->
</tr>
</table>
<table width="100%" cellpadding="0" cellspacing="5" class="registercontent">
<tr>
<th>Customize your league table</th>
<th>top 10 Lawyers</th>
</tr>
<tr>
<td>
<!--the filters-->
<form method="post" id="league_table_filter" action="lawyers_league_table_detail.php">
<table width="100%" cellpadding="0" cellspacing="0" class="company">
<tr>
<td>For</td>
<td>
<input type="hidden" name="member_type" id="member_type" value="lawyer" />Lawyer
</td>
</tr>
