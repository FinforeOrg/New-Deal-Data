...
$g_view['data_count'] = 0;
$g_view['data'] = array();
$success = $g_mem->get_all_unactivated_reg_list($g_view['data'],$g_view['data_count']);
if(!$success){
	die("Cannot get unactivated data");
}
////////////////////////////////////////////////

////////////////////////////////////////////////////////
$g_view['heading'] = "List of Unactivated Accounts";
$g_view['content_view'] = "admin/unactivated_registration_list_view.php";
