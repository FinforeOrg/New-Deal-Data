...
if(isset($_POST['action'])&&($_POST['action']=="edit")){
	...
	$success = $g_preset->admin_edit_preset_for_sector_industry($g_view['preset_id'],$_POST,$validation_passed,$g_view['err']);
	if(!$success){
...
$g_view['content_view'] = "admin/preset_sector_industry_edit_view.php";
