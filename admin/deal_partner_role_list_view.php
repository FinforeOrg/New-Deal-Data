...
<option value="" <?php if($g_view['input']['partner_type']==""){?>selected="selected"<?php }?>>select</option>
<option value="bank" <?php if($g_view['input']['partner_type']=="bank"){?>selected="selected"<?php }?>>Bank</option>
<option value="law firm" <?php if($g_view['input']['partner_type']=="law firm"){?>selected="selected"<?php }?>>Law Firm</option>
</select><span class="err_txt"> *</span><br /><span class="err_txt"><?php echo $g_view['err']['partner_type'];?></span>
</td>
</tr>
...
if(0 == $g_view['role_count']){
	...
	for($j=0;$j<$g_view['role_count'];$j++){
		...
		<td><?php echo $g_view['role'][$j]['partner_type'];?>
		<input type="hidden" id="partner_type<?php echo $g_view['role'][$j]['role_id'];?>" value="<?php echo $g_view['role'][$j]['partner_type'];?>" /></td>
