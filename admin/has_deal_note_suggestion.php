<?php
/******************
given a deal id  it returns an image that suggest whether there
is any note suggestions or note
******************************/
...
$found = $g_deal_support->admin_has_note_correction_on_deal($deal_id);
if(!$found){
	//echo "no suggestion";
	header("Content-type: image/png");
	echo file_get_contents("images/light-bulb-off.png");
