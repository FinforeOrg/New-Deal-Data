...
if(isset($_POST['myaction'])&&($_POST['myaction']=="search")){
	...
	$success = $g_misc->admin_get_blf_name_with_sp_char_paged($_POST,$g_view['start'],$g_view['num_to_show']+1,$g_view['data'],$g_view['data_count']);
	if(!$success){
		die("Cannot get data");
	}
}
////////////////////////////////////////////////
$g_view['heading'] = "List of bank / law firm name with special char";
$g_view['content_view'] = "admin/misc_list_blf_name_with_sp_char_view.php";
