...
function back_to_list(){
	window.location = "issuance_page_chart_list.php?start=<?php echo $g_view['start'];?>";
}
</script>
...
?>
<option value="<?php echo $g_view['deal_size_filter_list'][$i]['condition'];?>" <?php if($g_view['data']['deal_size']==$g_view['deal_size_filter_list'][$i]['condition']){?>selected="selected"<?php }?> ><?php echo $g_view['deal_size_filter_list'][$i]['caption'];?></option>
<?php
}
?>
</select>
...
<option value="" <?php if($g_view['data']['month_division']==""){?>selected="selected"<?php }?>>Select</option>
<option value="q" <?php if($g_view['data']['month_division']=="q"){?>selected="selected"<?php }?>>Quarterly</option>
<option value="h" <?php if($g_view['data']['month_division']=="h"){?>selected="selected"<?php }?>>Semi-Annual</option>
<option value="y" <?php if($g_view['data']['month_division']=="y"){?>selected="selected"<?php }?>>Annual</option>
</select><span class="err_txt">*</span><br />
...
for($j=0;$j<$g_view['month_div_cnt'];$j++){
	?>
	<option value="<?php echo $g_view['month_div']['value_arr'][$j];?>" <?php if($g_view['data']['month_division_list']==$g_view['month_div']['value_arr'][$j]){?>selected="selected"<?php }?>><?php echo $g_view['month_div']['label_arr'][$j];?></option>
	<?php
}
?>
</select><span class="err_txt">*</span><br />
...
<tr>
<td colspan="2"><img src="charts/<?php echo $g_view['data']['img'];?>" /></td>
</tr>
