...
if(isset($_POST['action'])&&($_POST['action']=="edit")){
	...
	$success = $g_preset->admin_edit_preset_for_country($g_view['preset_id'],$_POST,$validation_passed,$g_view['err']);
	if(!$success){
		die("Cannot edit country preset");
	}
...
$g_view['content_view'] = "admin/preset_country_edit_view.php";
