...
if(isset($_POST['action'])&&($_POST['action']=="add")){
	...
	$success = $g_deal_support->admin_add_deal_partner_role($_POST,$validation_passed,$g_view['err']);
	if(!$success){
		die("Cannot add role");
	}
...
if(isset($_POST['myaction'])&&($_POST['myaction']=="update")){
	$validation_passed = false;
	$success = $g_deal_support->admin_update_deal_partner_role($_POST['role_id'],$_POST,$validation_passed,$g_view['msg']);
	if(!$success){
...
$g_view['role_count'] = 0;
$g_view['role'] = NULL;
$success = $g_deal_support->admin_get_all_deal_partner_roles($g_view['role'],$g_view['role_count']);
if(!$success){
	die("Cannot get data");
}
/***********************************************************
...
/****************************************************************/
$g_view['heading'] = "List of Deal Partner Roles";
$g_view['content_view'] = "admin/deal_partner_role_list_view.php";
