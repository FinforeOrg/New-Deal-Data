...
****/
?>
<form id="addPressReleases" name="addPressReleases" method="post" action="pr.php?action=editPressRelease&id=<?php echo (int) $_GET['id'] ?>">
<table width="600" border="0">
  <tr>
    <td>Press release text<br />
        <textarea name="presReleaseText" cols="25" rows="9" style="width:100%"><?php echo stripslashes($pressRelease['text'])?></textarea>
    </td>
  </tr>
  <tr>
    <td>Tags (separated by comma)
    <br />    
      <input type="text" name="tags" id="tags" style="width:100%" value="<?php echo $tags ?>"/>
    </td>
  </tr>
    <tr>
    <td>Date 
    <br />    
      <input type="text" name="date" id="date" value="<?php echo date('d F Y',strtotime($pressRelease['date'])) ?>"/>
    </td>
  </tr>
  <?php
  /*****
  ...
  ***/
  ...
  <tr>
    <td>Deal number 
    <br />    
      <input type="text" name="deal_id" id="deal_id" value="<?php echo $pressRelease['deal_id']; ?>"/>
    </td>
  </tr>
  <tr>
    <td align="right">
      ...
      <label>
        <input type="submit" name="submit" id="submit" value="Update press release" />
      </label>
    </td>
  </tr>
</table>
