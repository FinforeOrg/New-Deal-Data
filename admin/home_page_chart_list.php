...
if(isset($_POST['action'])&&($_POST['action']=="del")){
	...
	****/
	$success = $g_stat->delete_home_page_chart($_POST['id'],$g_view['msg']);
	if(!$success){
...
$success = $g_stat->get_home_page_chart_list_paged($g_view['start'],$g_view['num_to_show']+1,$g_view['data'],$g_view['data_count']);
if(!$success){
	die("Cannot get chart list");
}
///////////////////////////////////////////////////////////
$g_view['heading'] = "List Home Page Charts";
$g_view['content_view'] = "admin/home_page_chart_list_view.php";
