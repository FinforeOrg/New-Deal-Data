...
<option value="bank" <?php if($g_view['input']['company_type']=="bank"){ ?> selected="selected"<?php }?>>Bank</option>
<option value="law firm" <?php if($g_view['input']['company_type']=="law firm"){ ?> selected="selected"<?php }?>>Law Firm</option>
<option value="company" <?php if($g_view['input']['company_type']=="company"){ ?> selected="selected"<?php }?>>Company</option>
</select><br />
...
<td>Email suffix</td>
<td>
<input name="email_suffix" type="text" style="width:200px;" value="<?php echo $g_view['input']['email_suffix'];?>" /><span class="err_txt"> *</span><br />(Ex: @credit-suisse.com)<br />
