<?php
/**********
used by admin code to get the list of currencies.
...
$success = $deal_support->ajax_admin_get_currency_suggestions($input,$temp_arr,$data_count);
if(!$success){
...
for($i=0;$i<$data_count;$i++){
	$data_arr['suggestions'][] = $temp_arr[$i]['code']." - ".$temp_arr[$i]['name'];
	$data_arr['data'][] = $temp_arr[$i]['code'];
}
echo json_encode($data_arr);
exit;
?>