...
<tr>
<td>The underlying security is different to the issuer:</td>
<td><?php if($g_view['data']['underlying_security_is_different'] == 'y') echo "Yes"; else echo "No";?></td>
</tr>

<?php
if($g_view['data']['underlying_security_is_different'] == 'y'){
?>
<tr>
<td>Name of underlying security:</td>
<td><?php echo $g_view['data']['company_security'];?></td>
</tr>

<tr>
<td>Sector of underlying security:</td>
<td><?php echo $g_view['data']['sector_security'];?></td>
</tr>

<tr>
<td>Industry of underlying security:</td>
<td><?php echo $g_view['data']['industry_security'];?></td>
</tr>
<?php
}
?>
...
<td><?php if($g_view['data']['reference_price']!=0.0) echo $g_view['data']['reference_price'];?></td>
</tr>

<tr>
<td>Currency of reference price:</td>
<td><?php echo $g_view['data']['currency_reference_price'];?></td>
</tr>

<tr>
<td>Conversion price:</td>
<td><?php if($g_view['data']['conversion_price']!=0.0) echo $g_view['data']['conversion_price'];?></td>
</tr>

<tr>
<td>Conversion premium (%):</td>
<td><?php if($g_view['data']['conversion_premia_percent']!=0.0) echo $g_view['data']['conversion_premia_percent'];?></td>
</tr>

<tr>
<td>Number of shares underlying (in million):</td>
<td><?php if($g_view['data']['num_shares_underlying_million']!=0.0) echo $g_view['data']['num_shares_underlying_million'];?></td>
</tr>

<tr>
<td>Current number of shares in issue (in million):</td>
...
<td><?php if($g_view['data']['dividend_protection'] == 'y') echo "Yes"; else echo "No";?></td>
</tr>
