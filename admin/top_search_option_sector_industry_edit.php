...
if(isset($_POST['action'])&&($_POST['action']=="edit")){
	...
	$success = $g_preset->admin_edit_top_search_option_for_sector_industry($g_view['option_id'],$_POST,$validation_passed,$g_view['err']);
	if(!$success){
		die("Cannot edit sector industry top search option");
	}
...
$g_view['content_view'] = "admin/top_search_option_sector_industry_edit_view.php";
