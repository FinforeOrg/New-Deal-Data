...
if($g_view['data_count']==0){
	...
	for($i=0;$i<$g_view['data_count'];$i++){
		...
		<td>
		<a href="preset_country_edit.php?preset_id=<?php echo $g_view['data'][$i]['preset_id'];?>">Edit</a>
		</td>
		<td>
		<a href="preset_country_detail.php?preset_id=<?php echo $g_view['data'][$i]['preset_id'];?>">View</a>
		</td>
		</tr>
		<?php
	}
