...
if($g_view['data_count']==0){
	...
	for($i=0;$i<$g_view['data_count'];$i++){
		...
		<td>
		<a href="top_search_option_country_edit.php?option_id=<?php echo $g_view['data'][$i]['option_id'];?>">Edit</a>
		</td>
		<td>
		<a href="top_search_option_country_preset_mapping.php?option_id=<?php echo $g_view['data'][$i]['option_id'];?>">Mapping</a>
		</td>
		</tr>
		<?php
	}
