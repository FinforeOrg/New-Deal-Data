<?php
/****************
This is used to search for law firm when the visitor type law firm name and select Law Firm
...
if(isset($_POST['myaction'])&&($_POST['myaction']=="search")){
	...
	$success = $g_company->front_firm_search_paged($_POST['top_search_term'],"law firm",$g_view['start_offset'],$g_view['num_to_show']+1,$g_view['data'],$g_view['data_count'],$g_view['total_data_count']);
...
/////////////////////////////////////////////////////////////////////////////////
$g_view['page_heading'] = "Law firm search result";
if(isset($g_view['total_data_count'])&&($g_view['total_data_count'] > 0)){
	$g_view['page_heading'].=" [".$g_view['total_data_count']." found]";
}
/***
sng:19/may/2010
We now use the default search view which can search for law firm
*******/
$g_view['content_view'] = "law_firm_search_view.php";
