...
get all, including ghost members since this is for deal team
and ghost members can be added
********/
...
if(isset($_POST['name'])){
	...
	if(strlen($name) >0) {
		...
		$data_arr = array();
		$data_cnt = 0;
		$success = $g_mem->ajax_get_members_for_deal_team($name,$_POST['type'],$_POST['company_id'],10,$data_arr,$data_cnt);
		if(!$success){
			//do nothing
			//echo "error";
		}else{
