...
/*******************
29/july/2011
handles Equity Rights correction
...
if(isset($_POST['date_ex_rights'])&&($_POST['date_ex_rights']!="")){
	$suggestion_ins_q.=",date_ex_rights='".$_POST['date_ex_rights']."'";
}
...
if(isset($_POST['curr_num_shares_outstanding_million'])&&($_POST['curr_num_shares_outstanding_million']!="")){
	$suggestion_ins_q.=",curr_num_shares_outstanding_million='".$_POST['curr_num_shares_outstanding_million']."'";
}
if(isset($_POST['subscription_ratio'])&&($_POST['subscription_ratio']!="")){
	$suggestion_ins_q.=",subscription_ratio='".mysql_real_escape_string($_POST['subscription_ratio'])."'";
}
/*********************
sng:15/mar/2012
...
if(isset($_POST['terp'])&&($_POST['terp']!="")){
	$suggestion_ins_q.=",terp='".$_POST['terp']."'";
}
if(isset($_POST['discount_to_terp'])&&($_POST['discount_to_terp']!="")){
	$suggestion_ins_q.=",discount_to_terp='".$_POST['discount_to_terp']."'";
}
if(isset($_POST['subscription_rate_percent'])&&($_POST['subscription_rate_percent']!="")){
	$suggestion_ins_q.=",subscription_rate_percent='".$_POST['subscription_rate_percent']."'";
}
if(isset($_POST['rump_placement'])&&($_POST['rump_placement']!="")){
	$suggestion_ins_q.=",rump_placement='".$_POST['rump_placement']."'";
}
if(isset($_POST['num_shares_sold_in_rump_million'])&&($_POST['num_shares_sold_in_rump_million']!="")){
	$suggestion_ins_q.=",num_shares_sold_in_rump_million='".$_POST['num_shares_sold_in_rump_million']."'";
}
if(isset($_POST['price_per_share_in_rump'])&&($_POST['price_per_share_in_rump']!="")){
	$suggestion_ins_q.=",price_per_share_in_rump='".$_POST['price_per_share_in_rump']."'";
}
