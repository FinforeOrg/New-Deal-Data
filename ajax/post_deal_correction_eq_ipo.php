...
if(isset($_POST['greenshoe_included'])&&($_POST['greenshoe_included']!="")){
	$suggestion_ins_q.=",greenshoe_included='".mysql_real_escape_string($_POST['greenshoe_included'])."'";
}
/*********************
sng:15/mar/2012
...
if(isset($_POST['price_at_end_of_first_day'])&&($_POST['price_at_end_of_first_day']!="")){
	$suggestion_ins_q.=",price_at_end_of_first_day='".$_POST['price_at_end_of_first_day']."'";
}
if(isset($_POST['date_first_trading'])&&($_POST['date_first_trading']!="")){
	$suggestion_ins_q.=",date_first_trading='".$_POST['date_first_trading']."'";
}
if(isset($_POST['1_day_price_change'])&&($_POST['1_day_price_change']!="")){
	$suggestion_ins_q.=",1_day_price_change='".$_POST['1_day_price_change']."'";
}

if(isset($_POST['ipo_stock_exchange'])&&($_POST['ipo_stock_exchange']!="")){
	$suggestion_ins_q.=",ipo_stock_exchange='".mysql_real_escape_string($_POST['ipo_stock_exchange'])."'";
}

if(isset($_POST['base_fee'])&&($_POST['base_fee']!="")){
	$suggestion_ins_q.=",base_fee='".$_POST['base_fee']."'";
}
if(isset($_POST['incentive_fee'])&&($_POST['incentive_fee']!="")){
	$suggestion_ins_q.=",incentive_fee='".$_POST['incentive_fee']."'";
}
/*************
sng:15/mar/2012
