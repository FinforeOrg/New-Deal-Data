...
This is called to submit corrective suggestion for company identifers.
...
$success = $comp_suggestion->front_submit_company_identifier_corrective_suggestion($company_id,$this_member,$_POST,$validation_passed,$result['msg']);
if(!$success){
	$result['msg'] = "Could not send the company identifiers";
	$result['success'] = 'n';
	echo json_encode($result);
	exit;
}
