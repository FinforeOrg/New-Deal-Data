	...
	_refreshPosition: function(){	
		...
		this.list
			.css({
				...
				result: If there is a select under another select, the dropdown list from upper select
				is getting behind the lower select.
				Commenting this line prevents the code from setting z-index of the dropdown list to 0 and all is ok
