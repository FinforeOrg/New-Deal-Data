...
function goto_league_table(){
	...
	document.getElementById("league_table_filter").action="lawyers_league_table.php";
...
<span class="err_txt" id="err_ranking_criteria"></span>
	...
	<td colspan="1">&nbsp;</td>
	<td style="text-align: right;"><input name="chart" type="submit" class="btn_auto" value="Lawyers" onclick=" return goto_league_table();" /></td>
...
if(0==$g_view['data_count']){
	...
	<input type="hidden" name="member_type" id="member_type" value="lawyer" />
